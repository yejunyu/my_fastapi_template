...
class AccessToken:
    ...
    def __init__(self, user_id: str, app_id: str, app_key: str):
        ...
        self.expire_at = int(time.time()) + 86400  # default expire time is 24 hours
        self.privileges = {}
        self.signature = ""
...
def parse(raw, user_id: str, app_id: str, app_key: str):
    try:
        ...
        token = AccessToken(user_id, app_id, app_key)
